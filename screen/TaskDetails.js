...
import { View, Text, StyleSheet, TouchableOpacity, ActivityIndicator, FlatList, Alert, RefreshControl } from 'react-native';
          ...
          renderItem={({ item }) => {
            ...
            return (
              <View style={styles.taskCard}>
                ...
                {pastTask && <Text style={styles.missedTask}>⚠️ Missed Task</Text>}
